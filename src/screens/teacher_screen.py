...
def teacher_screen():
    ...
    #teacher ko login page par redirect karo
...
def teacher_dashboard():
    ...
    with c2:
        ...
        if st.button("Logout",type='secondary',key='loginbackbtn',shortcut="control+L",width='stretch'):
...
def teacher_screen_register():
    ...
    teacher_password = st.text_input("Enter password",type="password",placeholder="Enter passowrd")
    teacher_password_confirm = st.text_input("Confirm your password",type="password",placeholder="Confirm passowrd")
    ...
    with btnc1:
        if st.button('Register now',icon=':material/passkey:',width="stretch"):
            ...
            if success:
                ...
                import time
                time.sleep(2)
                st.session_state_teacher_login_type = "login"
                st.rerun()
            else:
                st.error(message)
